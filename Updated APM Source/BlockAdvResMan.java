...
public class BlockAdvResMan extends BlockContainer implements ITileEntityProvider
{
	...
	public BlockAdvResMan(Material material)
	{
		super(material);
	}
    ...
    @Override
    public void getSubBlocks(Item itemblock, CreativeTabs creativetabs, List list)
	{
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer entityplayer, int par6, float par7, float par8, float par9)
	{
		...
		if (tile instanceof TECommon)
		{
			...
			if (AdvancedResourceManagement.proxy.isServer())
			{
				entityplayer.openGui(AdvancedResourceManagement.instance, id, world, x, y, z);
			}
		}
...
//	@Override
//	public boolean hasTileEntity(int metadata) { return metadata >= 0 && metadata <= Info.LAST_META_VALUE; }

//	@Override
//	public int idDropped(int var1, Random var2, int var3) { return blockID; }
	...
	{
		if (!AdvancedResourceManagement.proxy.isClient())
		{
			...
			{
				FMLLog.getLogger().warn(Info.TITLE_LOG + "Attempted to destroy APM block with non-APM tile entity at: " + i + ", " + j + ", " + k);
			}
			tile.invalidate();
		}
	}
