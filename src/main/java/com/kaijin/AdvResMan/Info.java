...
public class Info
{
    ...
    public static final String MOD_ID = "AdvResMan";
    public static final String TITLE_PACKED = "AdvancedResourceManagement";
    public static final String TITLE = "Advanced Resource Management";
    public static final String TITLE_LOG = "[" + TITLE_PACKED + "] ";
    public static final String CLIENT_PROXY = "com.kaijin.AdvResMan.proxy.CommonProxy";
    public static final String SERVER_PROXY = "com.kaijin.AdvResMan.proxy.CommonProxy";
    public static final String CONFIG_GUI_FACTORY = "com.kaijin.AdvResMan.config.ConfigGuiFactory";
